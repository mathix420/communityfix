# Chaîne email — Raphaëlle Thiollier, Ville de Paris (Cours Oasis)

---

## Message 1 — Prise de contact

**À :** raphaelle.thiollier@paris.fr
**Objet :** Cours Oasis documenté sur CommunityFix — vérification et enrichissement

---

Madame Thiollier,

Je me permets de vous contacter au sujet du programme **Cours Oasis**, que nous avons documenté comme étude de cas de référence sur **CommunityFix** (communityfix.org), notre plateforme de partage de solutions pour les défis urbains et climatiques.

Votre démarche — transformer des cours d'école imperméabilisées en îlots de fraîcheur, avec 10 sites pilotes ouvrant la voie à près de 760 écoles parisiennes — illustre précisément le type d'initiative que nous souhaitons rendre visible et reproductible à l'échelle mondiale.

Je vous contacte pour deux raisons :

1. **Vérifier l'exactitude** des informations publiées et corriger tout écart éventuel.
2. **Vous inviter à enrichir la fiche** avec des éléments que vous jugez pertinents (métriques, enseignements, ressources).
...
**À :** raphaelle.thiollier@paris.fr
**Objet :** Re : Cours Oasis documenté sur CommunityFix — vérification et enrichissement

---

Madame Thiollier,

Je me permets de revenir vers vous suite à mon message du [date d'envoi].
...
**À :** raphaelle.thiollier@paris.fr
**Objet :** Dernière relance — Cours Oasis sur CommunityFix
...
Merci pour le travail remarquable accompli avec les équipes OASIS.
