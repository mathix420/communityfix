# Chaîne email — Bruxelles Environnement

---

## Message 1 — Prise de contact

**À :** info@environnement.brussels
**Objet :** Votre action de poulaillers co-construits à Etterbeek documentée sur CommunityFix

Bonjour,

Je me permets de vous contacter au sujet de l'action de poules menée à Etterbeek, financée dans le cadre d'un appel à projets de Bruxelles Environnement et dont les poulaillers ont été co-construits avec les habitant·e·s.

Cette initiative est référencée comme étude de cas sur **CommunityFix** (communityfix.org), une plateforme ouverte qui documente des solutions concrètes à des défis urbains et environnementaux, pour les rendre accessibles et reproductibles ailleurs.

Je vous contacte pour deux raisons :

1. **Vérifier l'exactitude** des informations publiées — si certains éléments sont inexacts ou incomplets, nous serions heureux de les corriger.
2. **Enrichir la fiche** — métriques, retours d'expérience, liens vers vos ressources — pour maximiser l'utilité de ce cas pour d'autres porteurs de projets.
...
**À :** info@environnement.brussels
**Objet :** Re : Votre action de poulaillers co-construits à Etterbeek documentée sur CommunityFix
...
**À :** info@environnement.brussels
**Objet :** Re : Votre action de poulaillers co-construits à Etterbeek — dernier message
