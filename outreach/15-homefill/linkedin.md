# LinkedIn — Homefill / Kim Whitehead

**Profile:** https://www.linkedin.com/in/kimwhitehead/

---

## Connection note (≤300 characters)

Hi Kim — I'm Arnaud, founder of CommunityFix. We've featured Homefill as a reference case study (9,500+ bottles diverted in 2024!) and I'd love a moment of your time to make sure it's accurate. Happy to share the link.
...
Thanks for connecting! As mentioned, I run CommunityFix (communityfix.org) — an open platform that maps real-world community solutions so others can replicate them.
...
2. **Optional enrichment** — If you're open to sharing any updated figures, hard-won lessons, or photos, it would make the case study significantly more useful to the zero-waste and circular-economy community.

No obligation on either front — just wanted you to know the work is documented and being seen.
