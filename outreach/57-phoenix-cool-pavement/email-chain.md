# Email Chain — Case Study 57: Phoenix CoolSeal Cool-Pavement

**To:** sustainability@phoenix.gov
**Language:** English
...
**Subject:** Phoenix's CoolSeal programme documented on CommunityFix

Hi,

I'm Arnaud Gissinger, founder of CommunityFix (communityfix.org) — an open knowledge base where cities and communities share real-world evidence on urban challenges and the solutions they've tried.

I'm writing because we've documented Phoenix's CoolSeal cool-pavement deployment as a case study on our platform. The programme stands out not just for its scale — 36 miles of treated streets — but for the honesty of its findings: the ASU evaluation showed meaningful surface cooling while also surfacing an unexpected trade-off around increased pedestrian radiant load. That kind of nuanced, real-world result is exactly what CommunityFix is built to capture and share with other cities facing similar heat challenges.

I'd be grateful for two things:
...
Thank you for the work Phoenix is doing on urban heat — it's genuinely useful for cities everywhere.
...
**Subject:** Re: Phoenix's CoolSeal programme documented on CommunityFix

Hi,

I wanted to follow up briefly on my note from last week about Phoenix's CoolSeal case study on CommunityFix.
