# Chaîne email — Communauté de communes du Pays Fléchois

---

## Message 1 — Prise de contact

**À :** contact@cc-paysflechois.fr
**Objet :** Votre démarche de recontractualisation textile documentée sur CommunityFix

Bonjour,

Je me permets de vous contacter au sujet d'une initiative que vous avez portée en Sarthe : la recontractualisation d'un nouveau collecteur de textile après la suspension de Le Relais.

Cette démarche est documentée comme étude de cas sur CommunityFix (communityfix.org), une plateforme qui recense des solutions concrètes à des problèmes d'intérêt général, afin d'aider d'autres collectivités à s'en inspirer.

Je vous contacte pour deux raisons :
1. **Vérifier l'exactitude** des informations publiées — votre retour d'expérience direct est précieux pour garantir la fiabilité de la fiche.
2. **Vous inviter à l'enrichir** si vous souhaitez partager des éléments supplémentaires (métriques, enseignements, points de vigilance pour d'autres collectivités).
...
**À :** contact@cc-paysflechois.fr
**Objet :** Rép. : Votre démarche de recontractualisation textile documentée sur CommunityFix
