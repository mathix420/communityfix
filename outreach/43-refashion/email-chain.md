# Chaîne email — Valentine Roger · Refashion

---

## Message 1 — Prise de contact

**À :** vroger@lavillagroupe.com
**Objet :** CommunityFix — Refashion documentée comme étude de cas de référence

Madame Roger,

Je me permets de vous contacter au sujet de Refashion, dont le programme de hausse d'urgence des soutiens REP à la tonne — mis en place pour préserver la filière française du tri textile — est documenté comme étude de cas de référence sur CommunityFix (communityfix.org).

CommunityFix est une plateforme publique qui recense les solutions concrètes à des problèmes collectifs, avec les organisations qui les ont mises en œuvre. L'objectif est de rendre ces expériences réutilisables par d'autres acteurs, en France et à l'international.

Nous souhaiterions deux choses :
1. Vous inviter à vérifier l'exactitude des informations publiées sur le projet de Refashion.
2. Vous proposer de les enrichir — métriques, sources, enseignements — si vous le souhaitez.
...
**À :** vroger@lavillagroupe.com
**Objet :** Re : CommunityFix — Refashion documentée comme étude de cas de référence

Madame Roger,

Je me permets de revenir vers vous suite à mon message du 13 juin.

Pour rappel, il s'agit de la fiche CommunityFix consacrée au programme d'urgence Refashion sur les soutiens REP à la tonne, qui a joué un rôle déterminant pour maintenir en activité plusieurs centres de tri textiles en France.
...
**À :** vroger@lavillagroupe.com
**Objet :** Re : CommunityFix — Refashion (dernier message)
