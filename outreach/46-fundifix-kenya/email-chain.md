# Email Chain — FundiFix (info@fundifix.org)

---

## Message 1 — Initial outreach

**To:** info@fundifix.org
**Subject:** FundiFix featured as a case study on CommunityFix

---

Hello,

I'm writing to let you know that FundiFix's professionalised handpump maintenance service in Kitui and Kwale Counties has been documented as a reference case study on CommunityFix (communityfix.org).

CommunityFix is an open platform that maps proven solutions to real community problems. Your work — professionalising rural water point maintenance through performance contracts and remote monitoring — is exactly the kind of evidence-based practice we want practitioners worldwide to be able to discover and replicate.
...
2. **Enrichment** — if you have metrics, cost data, lessons learned, or links to reports you're happy to share publicly, we can add them to make the case study more useful to others.

There's no obligation; even a brief "looks good" or a correction by reply is genuinely helpful.

Thank you for what you're doing for rural water access in Kenya.
...
**To:** info@fundifix.org
**Subject:** Re: FundiFix featured as a case study on CommunityFix

---

Hello,

I wanted to follow up on my note from last week. I appreciate how busy operational teams are, so I'll keep this short.
