# LinkedIn Outreach — Algramo / José Manuel Moller

**Profile / page:** https://www.linkedin.com/company/algramo

---

## Connection note (≤300 characters)

Hi José Manuel — I'm Arnaud, founder of CommunityFix. We've published Algramo's RFID refill model as a reference case study and would love your input to keep it accurate. Happy to share the link!
...
2. **Enrichment** — if there are more recent metrics, scaling lessons, or photos we could link to, they'd make the case study even more useful for teams in other cities trying to replicate what you've done.

No cost, no strings. Attribution stays with Algramo, and the content is openly accessible to anyone.

Would you or a colleague be open to a quick look? I can send the direct link whenever convenient.

Thanks again — and genuinely, congratulations on what Algramo has achieved.
