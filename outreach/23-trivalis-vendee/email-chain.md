# Chaîne email — Trivalis (Vendée)

Destinataire : contact@trivalis.fr
...
Je me permets de vous contacter au sujet d'un programme que Trivalis a mené en Vendée : la distribution de 1 200 poules avec poulaillers fournis, dans le cadre d'une stratégie décennale de prévention des biodéchets.

Ce programme est documenté comme étude de cas de référence sur CommunityFix (communityfix.org), une plateforme collaborative qui recense des solutions concrètes aux grands défis environnementaux et sociaux, afin que d'autres collectivités puissent s'en inspirer.

Je vous contacte pour deux raisons :
1. **Vérifier l'exactitude** des informations publiées — si certains éléments méritent d'être corrigés ou précisés, nous le ferons volontiers.
2. **Enrichir la fiche** avec des données que vous jugez utiles à partager : indicateurs de résultats, retours des bénéficiaires, points de vigilance, etc.
...
**Objet :** Dernière relance — étude de cas Trivalis sur CommunityFix
