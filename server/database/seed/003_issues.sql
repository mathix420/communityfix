...
-- Additional topic-diverse branches. These deliberately cover community needs
-- that were absent from the original climate-heavy fixture set so feeds,
-- filters, profiles, and contribution prompts have a broader playground.
INSERT INTO issues (
  id, title, summary, description, author_id,
  solution_count, sub_issue_count, status, type,
  location_name, location, scale, help_labels,
  created_at, updated_at
) VALUES
  (1001, 'Safer walking routes to school',
   'Children and caregivers need a connected network of calm streets, visible crossings, and protected walking routes between homes, schools, and transit stops.',
   E'Many school journeys that are short enough to walk still feel unsafe because crossings are missing, vehicle speeds are high, and pavements end abruptly. The burden falls especially heavily on younger children, disabled pupils, and families without a car.\n\nA useful response must connect the whole journey rather than improve a single junction. Schools, street designers, families, and transit operators need a shared way to identify danger points and test changes before committing to permanent construction.',
   'a0000002-0000-4000-8000-000000000002',
   2, 0, 'approved', 'issue',
   'Utrecht, Netherlands', ST_SetSRID(ST_MakePoint(5.1214, 52.0907), 4326), 'city',
   ARRAY['needs-baseline', 'needs-location']::text[],
   '2026-05-02T08:30:00.000Z', '2026-05-02T08:30:00.000Z'),

  (1004, 'Reduce neighborhood heat risk',
   'Dense neighborhoods need shade, cool public spaces, and practical heat-response plans as longer and hotter summer periods put residents at risk.',
   E'Heat exposure is not evenly distributed across a city. Blocks with little tree canopy, dark roofs, busy roads, and small flats can remain dangerously warm overnight while greener districts cool down.\n\nThe strongest local plans combine physical changes with public-health outreach: shade the routes people use, cool the buildings that overheat, identify isolated residents, and keep trusted public spaces open during heat alerts.',
   'a0000001-0000-4000-8000-000000000001',
   2, 0, 'approved', 'issue',
   'Athens, Greece', ST_SetSRID(ST_MakePoint(23.7275, 37.9838), 4326), 'city',
   ARRAY['needs-baseline', 'needs-cost']::text[],
   '2026-05-04T10:00:00.000Z', '2026-05-04T10:00:00.000Z'),

  (1007, 'Close the rural digital divide',
   'Rural households need reliable broadband, affordable devices, and nearby support to use essential digital services without travelling to a city.',
   E'Coverage maps often describe a region as connected even when homes experience weak signals, low speeds, or prices they cannot afford. Connectivity alone is also insufficient when residents lack a suitable device or confidence using online health, education, and government services.\n\nA community-led approach can document the real service gap, aggregate demand, and pair new infrastructure with lending and training so that a connection translates into meaningful access.',
   'a0000004-0000-4000-8000-000000000004',
   2, 0, 'approved', 'issue',
   'Asturias, Spain', ST_SetSRID(ST_MakePoint(-5.8494, 43.3614), 4326), 'region',
   ARRAY['needs-evidence', 'needs-location']::text[],
   '2026-05-06T09:15:00.000Z', '2026-05-06T09:15:00.000Z'),

  (1010, 'Affordable childcare for shift workers',
   'Parents working evenings, nights, and changing rosters need dependable childcare outside standard office hours without losing most of their income to fees.',
   E'Most childcare is designed around a predictable weekday schedule. Hospital staff, cleaners, hospitality workers, carers, and many other essential workers instead receive rotating shifts, creating gaps that informal family support cannot always cover.\n\nThe challenge is both financial and operational: demand varies by hour, safe staffing ratios must be maintained, and parents need confidence that a place will still be available when a roster changes.',
   'a0000006-0000-4000-8000-000000000006',
   2, 0, 'approved', 'issue',
   'Manchester, United Kingdom', ST_SetSRID(ST_MakePoint(-2.2426, 53.4808), 4326), 'city',
   ARRAY['needs-cost', 'needs-evidence']::text[],
   '2026-05-08T13:00:00.000Z', '2026-05-08T13:00:00.000Z'),

  (1013, 'Restore polluted urban waterways',
   'Communities living beside polluted creeks and rivers need transparent water-quality data and practical projects that stop waste before it reaches the water.',
   E'Urban waterways collect untreated runoff, litter, wastewater leaks, and sediment from across a watershed. One-off cleanups remove visible waste but do not reveal where pollution enters or prevent it from returning after the next storm.\n\nLasting restoration needs shared monitoring, rapid reporting of broken infrastructure, upstream prevention, and small ecological interventions that can be maintained by local groups alongside municipal systems.',
   'a0000007-0000-4000-8000-000000000007',
   2, 0, 'approved', 'issue',
   'Metro Manila, Philippines', ST_SetSRID(ST_MakePoint(120.9842, 14.5995), 4326), 'city',
   ARRAY['needs-baseline', 'needs-sources']::text[],
   '2026-05-10T07:45:00.000Z', '2026-05-10T07:45:00.000Z'),

  (1016, 'Improve access to community mental-health support',
   'People need low-barrier, culturally appropriate mental-health support close to home, especially before distress becomes an emergency.',
   E'Long waiting lists, cost, stigma, and a shortage of specialists keep many people from receiving support early. Centralized clinical services are particularly difficult to reach for young people, carers, and residents balancing insecure work.\n\nCommunity support cannot replace clinical care, but trained peers, clear referral pathways, and mobile teams can make the first conversation easier and help people reach the right level of care sooner.',
   'a0000003-0000-4000-8000-000000000003',
   2, 0, 'approved', 'issue',
   'Nairobi, Kenya', ST_SetSRID(ST_MakePoint(36.8219, -1.2921), 4326), 'city',
   ARRAY['needs-evidence', 'needs-sources']::text[],
   '2026-05-12T11:20:00.000Z', '2026-05-12T11:20:00.000Z'),

  (1019, 'Make public spaces accessible to everyone',
   'Streets, parks, civic buildings, and everyday services should be usable by disabled people, older residents, and caregivers without avoidable barriers.',
   E'A route can fail because of a single obstacle: a missing kerb ramp, an inaccessible toilet, poor contrast, steps at an entrance, or a crossing signal that cannot be heard. These barriers compound across a journey and exclude people from work, services, and community life.\n\nAccessibility improvements work best when residents with different disabilities lead the audit and when quick fixes are connected to a funded plan for structural changes.',
   'a0000008-0000-4000-8000-000000000008',
   2, 0, 'approved', 'issue',
   'Bucharest, Romania', ST_SetSRID(ST_MakePoint(26.1025, 44.4268), 4326), 'city',
   ARRAY['needs-location', 'needs-cost']::text[],
   '2026-05-14T09:40:00.000Z', '2026-05-14T09:40:00.000Z'),

  (1022, 'Strengthen neighborhood food security',
   'Neighborhoods need affordable fresh food and reliable ways to store and redistribute it before heat, transport delays, or price spikes turn shortages into crises.',
   E'Food insecurity is shaped by more than the amount of food produced. Small vendors lose perishable stock when cold storage is unavailable, households may live far from fresh-food markets, and surplus from restaurants or wholesalers is difficult to match with local demand in time.\n\nLocal resilience comes from linking growers, markets, kitchens, schools, and community organizations through simple logistics that reduce spoilage while protecting dignity and choice.',
   'a0000005-0000-4000-8000-000000000005',
   2, 0, 'approved', 'issue',
   'Lagos, Nigeria', ST_SetSRID(ST_MakePoint(3.3792, 6.5244), 4326), 'city',
   ARRAY['needs-baseline', 'needs-cost']::text[],
   '2026-05-16T08:10:00.000Z', '2026-05-16T08:10:00.000Z')
ON CONFLICT DO NOTHING;

INSERT INTO issues (
  id, parent_id, title, summary, description, author_id,
  solution_count, sub_issue_count, status, type,
  location_name, location, scale, solution_status, help_labels,
  created_at, updated_at
) VALUES
  (1002, 1001, 'Timed school streets at arrival and dismissal',
   'Temporarily restrict through-traffic on the streets immediately around schools during arrival and dismissal, with resident access and clearly marked diversion routes.',
   'Start with a reversible pilot using staffed barriers, signs, and traffic counts. Schools can adjust the closure window after gathering feedback from residents, disabled pupils, delivery workers, and families who cannot walk the full route.',
   'a0000004-0000-4000-8000-000000000004',
   0, 0, 'approved', 'solution',
   'Utrecht, Netherlands', ST_SetSRID(ST_MakePoint(5.1214, 52.0907), 4326), 'city', 'in-progress',
   ARRAY['needs-baseline']::text[],
   '2026-05-02T12:00:00.000Z', '2026-05-02T12:00:00.000Z'),
  (1003, 1001, 'Child-led crossing and pavement audits',
   'Give pupils and caregivers a simple map-based audit to record dangerous crossings, blocked pavements, poor lighting, and places where vehicle speed feels unsafe.',
   'Combine observations with speed and collision data, then publish a ranked list of quick changes and capital projects. Repeat the walk after each intervention so the community can verify whether it solved the problem.',
   'a0000007-0000-4000-8000-000000000007',
   0, 0, 'approved', 'solution',
   'Utrecht, Netherlands', ST_SetSRID(ST_MakePoint(5.1214, 52.0907), 4326), 'city', 'plan',
   ARRAY['needs-cost']::text[],
   '2026-05-03T08:45:00.000Z', '2026-05-03T08:45:00.000Z'),

  (1005, 1004, 'Connected shade corridors to essential services',
   'Prioritize trees, fabric shade, seating, and drinking water along the walking routes that connect homes with transit, clinics, schools, and markets.',
   'Map surface temperature together with pedestrian routes and the locations residents must reach. Use fast temporary shade where tree canopy will take years to mature, and budget explicitly for watering and maintenance.',
   'a0000005-0000-4000-8000-000000000005',
   0, 0, 'approved', 'solution',
   'Athens, Greece', ST_SetSRID(ST_MakePoint(23.7275, 37.9838), 4326), 'city', 'in-progress',
   ARRAY['needs-cost', 'needs-location']::text[],
   '2026-05-04T15:30:00.000Z', '2026-05-04T15:30:00.000Z'),
  (1006, 1004, 'Cool-roof grants for apartment buildings',
   'Offer simple grants and group purchasing for reflective roof coatings, insulation, and shading in apartment buildings located in the hottest blocks.',
   'Tie support to before-and-after indoor temperature monitoring and reserve a higher subsidy for low-income buildings. A shared contractor framework can reduce procurement work for volunteer building associations.',
   'a0000001-0000-4000-8000-000000000001',
   0, 0, 'approved', 'solution',
   'Athens, Greece', ST_SetSRID(ST_MakePoint(23.7275, 37.9838), 4326), 'city', 'plan',
   ARRAY['needs-evidence']::text[],
   '2026-05-05T09:00:00.000Z', '2026-05-05T09:00:00.000Z'),

  (1008, 1007, 'Community-owned open-access fiber network',
   'Form a cooperative that builds shared fiber backhaul and leases equal wholesale access to local internet providers rather than locking the area to one operator.',
   'Aggregate household commitments before construction, publish the true build cost, and phase the network from the most viable cluster outward. Open access gives residents a choice of service while the physical network remains a community asset.',
   'a0000002-0000-4000-8000-000000000002',
   0, 0, 'approved', 'solution',
   'Asturias, Spain', ST_SetSRID(ST_MakePoint(-5.8494, 43.3614), 4326), 'region', 'plan',
   ARRAY['needs-cost', 'needs-evidence']::text[],
   '2026-05-06T14:10:00.000Z', '2026-05-06T14:10:00.000Z'),
  (1009, 1007, 'Device library with traveling digital support',
   'Lend laptops and hotspots through libraries while a rotating support team visits villages to help residents use health, learning, banking, and government services.',
   'Use refurbished devices with a standard accessible setup, clear privacy guidance, and offline learning material. Track which tasks residents request help with so training responds to actual needs instead of a generic curriculum.',
   'a0000008-0000-4000-8000-000000000008',
   0, 0, 'approved', 'solution',
   'Asturias, Spain', ST_SetSRID(ST_MakePoint(-5.8494, 43.3614), 4326), 'region', 'in-progress',
   ARRAY['needs-baseline']::text[],
   '2026-05-07T10:30:00.000Z', '2026-05-07T10:30:00.000Z'),

  (1011, 1010, 'Cooperative extended-hours childcare',
   'Create a parent-and-worker cooperative that pools demand across employers and provides bookable early-morning, evening, and weekend childcare.',
   'Start with the shift patterns of several nearby workplaces so demand is large enough to staff safely. Give families a stable core allocation plus a smaller pool of flexible hours for roster changes.',
   'a0000003-0000-4000-8000-000000000003',
   0, 0, 'approved', 'solution',
   'Manchester, United Kingdom', ST_SetSRID(ST_MakePoint(-2.2426, 53.4808), 4326), 'city', 'plan',
   ARRAY['needs-cost', 'needs-sources']::text[],
   '2026-05-08T17:20:00.000Z', '2026-05-08T17:20:00.000Z'),
  (1012, 1010, 'Pooled employer and municipal childcare fund',
   'Ask employers with shift work to match municipal subsidies in a shared fund that follows the family across approved childcare providers.',
   'A portable subsidy avoids tying parents to a single employer-run nursery. Contribution bands can reflect employer size and the number of nonstandard shifts, while a public dashboard reports coverage without exposing family data.',
   'a0000006-0000-4000-8000-000000000006',
   0, 0, 'approved', 'solution',
   'Manchester, United Kingdom', ST_SetSRID(ST_MakePoint(-2.2426, 53.4808), 4326), 'city', 'plan',
   ARRAY['needs-baseline', 'needs-cost']::text[],
   '2026-05-09T10:15:00.000Z', '2026-05-09T10:15:00.000Z'),

  (1014, 1013, 'Community water-quality monitoring network',
   'Equip schools and neighborhood groups to collect repeatable water samples, publish results on an open map, and escalate sudden changes to the responsible agency.',
   'Use a small set of measurements that volunteers can perform reliably, with periodic laboratory checks and a documented sampling protocol. The value comes from consistent locations and dates, not from collecting every possible metric.',
   'a0000004-0000-4000-8000-000000000004',
   0, 0, 'approved', 'solution',
   'Metro Manila, Philippines', ST_SetSRID(ST_MakePoint(120.9842, 14.5995), 4326), 'city', 'in-progress',
   ARRAY['needs-sources']::text[],
   '2026-05-10T13:00:00.000Z', '2026-05-10T13:00:00.000Z'),
  (1015, 1013, 'Pocket wetlands at polluted outfalls',
   'Build small planted treatment areas at selected drainage outfalls to slow runoff, trap litter and sediment, and demonstrate where upstream pollution remains unresolved.',
   'Select sites where land ownership and maintenance are clear. Monitor flow, sediment, and a few water-quality indicators before and after construction so the wetland is treated as infrastructure rather than decorative planting.',
   'a0000007-0000-4000-8000-000000000007',
   0, 0, 'approved', 'solution',
   'Metro Manila, Philippines', ST_SetSRID(ST_MakePoint(120.9842, 14.5995), 4326), 'city', 'plan',
   ARRAY['needs-cost', 'needs-location']::text[],
   '2026-05-11T08:30:00.000Z', '2026-05-11T08:30:00.000Z'),

  (1017, 1016, 'Trained peer-support network with warm referrals',
   'Train trusted community members to facilitate support groups, recognize urgent risk, and connect participants directly with appropriate clinical or social services.',
   'Peers should have supervision, safeguarding procedures, clear boundaries, and an up-to-date referral directory. Measure whether people successfully reach follow-on support rather than counting conversations alone.',
   'a0000002-0000-4000-8000-000000000002',
   0, 0, 'approved', 'solution',
   'Nairobi, Kenya', ST_SetSRID(ST_MakePoint(36.8219, -1.2921), 4326), 'city', 'in-progress',
   ARRAY['needs-evidence', 'needs-sources']::text[],
   '2026-05-12T16:00:00.000Z', '2026-05-12T16:00:00.000Z'),
  (1018, 1016, 'Mobile counseling clinics at familiar community sites',
   'Bring scheduled counseling and referral sessions to schools, markets, faith centers, and community halls using a consistent rotating timetable.',
   'Private spaces, secure records, clinical supervision, and continuity between visits are essential. Co-design the locations and hours with residents so the service reaches people who cannot attend a central clinic.',
   'a0000003-0000-4000-8000-000000000003',
   0, 0, 'approved', 'solution',
   'Nairobi, Kenya', ST_SetSRID(ST_MakePoint(36.8219, -1.2921), 4326), 'city', 'plan',
   ARRAY['needs-cost', 'needs-location']::text[],
   '2026-05-13T09:25:00.000Z', '2026-05-13T09:25:00.000Z'),

  (1020, 1019, 'Resident-led accessibility audit and repair map',
   'Pay disabled residents to audit complete journeys, publish barriers with severity and ownership, and track each repair from report to completion.',
   'The audit should cover mobility, vision, hearing, cognition, and sensory needs. Municipal teams can then group quick maintenance fixes separately from capital projects and explain publicly when a barrier cannot be removed immediately.',
   'a0000008-0000-4000-8000-000000000008',
   0, 0, 'approved', 'solution',
   'Bucharest, Romania', ST_SetSRID(ST_MakePoint(26.1025, 44.4268), 4326), 'city', 'in-progress',
   ARRAY['needs-baseline']::text[],
   '2026-05-14T14:30:00.000Z', '2026-05-14T14:30:00.000Z'),
  (1021, 1019, 'Rapid accessibility improvement crews',
   'Create a small cross-department crew authorized to fix kerb ramps, tactile paving, signs, seating, and minor entrance barriers without a full capital-project cycle.',
   'Publish a standard menu of eligible repairs and reserve part of the budget for routes to health, transit, and public services. Pair each quick fix with inspection by residents who identified the barrier.',
   'a0000001-0000-4000-8000-000000000001',
   0, 0, 'approved', 'solution',
   'Bucharest, Romania', ST_SetSRID(ST_MakePoint(26.1025, 44.4268), 4326), 'city', 'plan',
   ARRAY['needs-cost']::text[],
   '2026-05-15T10:00:00.000Z', '2026-05-15T10:00:00.000Z'),

  (1023, 1022, 'Shared solar cold rooms for market vendors',
   'Install pay-per-crate solar cold rooms managed by vendor cooperatives so small traders can preserve produce without buying individual equipment.',
   'Choose sites from measured spoilage and footfall data, publish transparent fees, and train local technicians. The operating model must cover cleaning, security, repairs, and battery replacement after grant funding ends.',
   'a0000005-0000-4000-8000-000000000005',
   0, 0, 'approved', 'solution',
   'Lagos, Nigeria', ST_SetSRID(ST_MakePoint(3.3792, 6.5244), 4326), 'city', 'in-progress',
   ARRAY['needs-cost', 'needs-evidence']::text[],
   '2026-05-16T13:15:00.000Z', '2026-05-16T13:15:00.000Z'),
  (1024, 1022, 'Same-day neighborhood food redistribution',
   'Use simple pickup windows and shared cargo-bike routes to move safe surplus food from markets and kitchens to community organizations on the same day.',
   'Keep the matching process lightweight: predictable collection times, agreed food-safety rules, reusable crates, and recipient choice wherever possible. Track avoided waste and fulfilled requests without creating burdensome paperwork for small donors.',
   'a0000006-0000-4000-8000-000000000006',
   0, 0, 'approved', 'solution',
   'Lagos, Nigeria', ST_SetSRID(ST_MakePoint(3.3792, 6.5244), 4326), 'city', 'plan',
   ARRAY['needs-baseline']::text[],
   '2026-05-17T08:50:00.000Z', '2026-05-17T08:50:00.000Z')
ON CONFLICT DO NOTHING;
