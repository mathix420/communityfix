...
-- SDG coverage for the additional community branches (1001-1024).
WITH sdg_map (issue_id, sdg_id) AS (
  VALUES
    (1001, 3), (1001, 4), (1001, 10), (1001, 11),
    (1002, 3), (1002, 11), (1003, 4), (1003, 11),
    (1004, 3), (1004, 11), (1004, 13),
    (1005, 3), (1005, 11), (1005, 13),
    (1006, 3), (1006, 7), (1006, 11), (1006, 13),
    (1007, 4), (1007, 9), (1007, 10),
    (1008, 9), (1008, 10), (1008, 17),
    (1009, 4), (1009, 9), (1009, 10),
    (1010, 5), (1010, 8), (1010, 10),
    (1011, 5), (1011, 8), (1011, 10),
    (1012, 5), (1012, 8), (1012, 10), (1012, 17),
    (1013, 6), (1013, 11), (1013, 14),
    (1014, 6), (1014, 14), (1014, 17),
    (1015, 6), (1015, 11), (1015, 14),
    (1016, 3), (1016, 10),
    (1017, 3), (1017, 10), (1017, 17),
    (1018, 3), (1018, 10),
    (1019, 10), (1019, 11),
    (1020, 10), (1020, 11), (1020, 16),
    (1021, 10), (1021, 11),
    (1022, 2), (1022, 3), (1022, 12),
    (1023, 2), (1023, 7), (1023, 8), (1023, 12),
    (1024, 2), (1024, 11), (1024, 12)
)
INSERT INTO issue_sdgs (issue_id, sdg_id)
SELECT m.issue_id, m.sdg_id
FROM sdg_map m
JOIN issues i ON i.id = m.issue_id
JOIN sdgs s ON s.id = m.sdg_id
ON CONFLICT DO NOTHING;
