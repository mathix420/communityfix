...
const presets = [
  ...
  {
    label: 'Duplicate of existing item',
    value: 'Duplicate of an existing issue or solution. Please contribute on the original.',
  },
  { label: 'Off-topic', value: 'This submission is off-topic for the platform.' },
  {
    label: 'Low effort / unclear',
    value:
      'Submission lacks the detail needed to evaluate or act on it. Please expand and resubmit.',
  },
  {
    label: 'Personal info / PII',
    value:
      'Contains personal information about identifiable individuals. Please remove and resubmit.',
  },
    ...
    <template #content>
      <div class="p-4 space-y-3">
        <div>
          ...
          <p v-if="target" class="text-xs text-toned mt-0.5">
            {{ target }}
          </p>
        </div>
        ...
        <p class="text-[11px] text-toned">
          Minimum 5 characters. Shown to the author.
        </p>
